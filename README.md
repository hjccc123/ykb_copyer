...
### Python环境
- Python 3.x
- 标准库模块：`os`, `json`, `re`, `shutil`, `sys`（Python自带，无需额外安装）
...
本项目仅供学习和研究使用，请勿用于商业用途。使用者需要注意：

1. 使用本工具抓取的数据仅供个人学习使用，请尊重原始数据的版权
2. 使用自动化工具访问APP可能违反服务条款，请自行评估法律风险
3. 作者不对使用本工具产生的任何后果承担责任
4. 建议遵守目标应用的使用协议和相关法律法规
